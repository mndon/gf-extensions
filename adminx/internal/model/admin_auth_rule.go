...
type AdminAuthRuleInfoRes struct {
...
// AdminAuthRuleTreeRes 菜单树形结构
type AdminAuthRuleTreeRes struct {
	*AdminAuthRuleInfoRes
	Children []*AdminAuthRuleTreeRes `json:"children"`
}
