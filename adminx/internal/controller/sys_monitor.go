...
var Monitor = adminMonitorController{
	startTime: gtime.Now(),
}
...
func (c *adminMonitorController) List(ctx context.Context, req *api.MonitorSearchReq) (res *api.MonitorSearchRes, err error) {
	...
	res = new(api.MonitorSearchRes)
	res = &api.MonitorSearchRes{
		"cpuNum":          cpuNum,
		"cpuUsed":         cpuUsed,
